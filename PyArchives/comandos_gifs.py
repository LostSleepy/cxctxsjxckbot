...
async def bf(ctx, usuario: discord.Member = None):
    ...
    async with ctx.typing():
        ...
        embed = discord.Embed(
            title="⚡¡Black Flash!⚡",
            description=f"{ctx.author.mention} le ha propinado un **Destello Negro** a {usuario.mention}.",
...
async def de(ctx, usuario: discord.Member = None):
    ...
    async with ctx.typing():
        ...
        embed = discord.Embed(
            ...
            description=f"{ctx.author.mention} ha desplegado su dominio sobre {usuario.mention}.",
